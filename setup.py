...
setuptools.setup(
    ...
    description="a web crawler based on scrapy that crawl the product items of a certain category and comments to the product。",  # 模块简介
    install_requires=[
        'requests',
        'faker',
        'execjs',
    ...
    url="https://github.com/yanjlee/ScrapyJD",  # 模块github地址
